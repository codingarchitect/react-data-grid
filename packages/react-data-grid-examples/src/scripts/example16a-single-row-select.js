...
const exampleDescription = (
  <div>
    <p>Single Row selection is enabled via the <code>rowSelection</code> prop (object). The following keys control behaviour:</p>
    <h4>selectBy</h4>
    <p>
    ...
    <p>
      ...
      This allows for single or multiple selection to be implemented as desired, by either appending to or <em>replacing</em> the list of selected items.
    </p>
    <h4>showCheckbox</h4>
